...
globalXSBRMap['tth_th_cp_Analysis']['tthCPodd'] = {'mode':'constant','factor':0.5638*( 0.245 / 0.5687)}
globalXSBRMap['tth_th_cp_Analysis']['tHqLep'] = {'mode':'constant','factor': 0.0832 * 0.3258}
globalXSBRMap['tth_th_cp_Analysis']['tHqLepCPodd'] = {'mode':'constant','factor': 0.0832 * 0.3258*(0.09406 / 0.02127)}
globalXSBRMap['tth_th_cp_Analysis']['tHqHad'] = {'mode':'constant','factor': 0.0832 * (1-0.3258)}
globalXSBRMap['tth_th_cp_Analysis']['tHqHadCPodd'] = {'mode':'constant','factor': 0.0832 * (1-0.3258)*(0.1902 / 0.04285)}
