...
signalScriptCfg = {
  ...
  'cats': 'tHq_had0_CP_mix', #'tHq_had0_CP_odd,tHq_had0_CP_even,ttH_had0_CP_even,ttH_had0_CP_odd,tHq_had0_CP_mix', #'auto', #'ttH_lep0_CP_even', #'auto', # if auto: inferred automatically from (0) workspace
